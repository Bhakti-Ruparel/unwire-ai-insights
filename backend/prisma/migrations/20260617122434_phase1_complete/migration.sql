...
-- CreateIndex
CREATE UNIQUE INDEX "backend_info_projectId_key" ON "backend_info"("projectId");
...
-- AddForeignKey
ALTER TABLE "external_services" ADD CONSTRAINT "external_services_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "projects"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "backend_info" ADD CONSTRAINT "backend_info_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "projects"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "schema_tables" ADD CONSTRAINT "schema_tables_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "projects"("id") ON DELETE CASCADE ON UPDATE CASCADE;
